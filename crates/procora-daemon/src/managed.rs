...
use procora_protocol::{ServiceStatusDto, ServiceViewDto};
use procora_storage::{StoredService, StoredServiceStatus};

use crate::{ServiceHost, status::stored_status};
...
fn restore_valid(
    ...
    discovered: procora_config::DiscoveredProject,
) -> ManagedService {
